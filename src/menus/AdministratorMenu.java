/*
 * The AdministratorMenu class is responsible for displaying options for the administrator 
 * and handling user input. This class calls methods from the Administrator class to perform actions.
 */
